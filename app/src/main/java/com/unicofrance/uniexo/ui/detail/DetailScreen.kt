    ...
    Column(
        ...
        Row(
            ...
            IconButton(
                ...
                onClick = { backToMap(container?.id ?: "") }
            ) {
                Icon(
        ...
        Column(
            ...
            DetailInfos(label = "ID", content = container?.id, modifier = Modifier.fillMaxWidth())
            Row(
                horizontalArrangement = Arrangement.spacedBy(16.dp)
            ) {
                DetailInfos(
                    label = "Latitude",
                    content = container?.latitude?.toString(),
                    modifier = Modifier.weight(1f)
                )
                DetailInfos(
                    label = "Longitude",
                    content = container?.longitude?.toString(),
                    modifier = Modifier.weight(1f)
                )
            }
            DetailInfos(
